...
Ember.Select2 = Ember.Namespace.create();
Ember.Select2.VERSION = '0.1.0';

Ember.libraries.register('Ember Select2', Ember.Select2.VERSION);
...
Ember.Select2.Select2Component = Ember.Component.extend({
    tagName: 'input',
    ...
    didInsertElement: function() {
        ...
        */
        ...
        options.formatResult = formatAny;
        options.formatSelection = formatAny;
...
Ember.Handlebars.helper('select-2', Ember.Select2.Select2Component);
